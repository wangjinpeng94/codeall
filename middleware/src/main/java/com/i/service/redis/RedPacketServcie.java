...
import com.i.utils.RedPacketUtil;
import com.i.utils.SnowFlake;
...
public class RedPacketServcie implements IRedPacketService {
    private static final Logger log = LoggerFactory.getLogger(RedPacketServcie.class);
    ...
    public String handOut(RedPacketDto dto) throws Exception {
        if (dto.getTotal()>0&&dto.getAmount()>0) {
            ...
            //异步记录红包发出的记录包括个数与随机金额
            redService.redcordRedPacket(dto,redId,list);
    ...
    public BigDecimal rob(Integer userId, String redId) throws Exception {
        ...
        if (res) {
            //上锁 ：一个红包每个人只能抢一次随机金额：
            // 一个人每次只能抢到红包的一次随机金额 即要永远保证1对1的关系
